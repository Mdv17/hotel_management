...
SECRET_KEY = 'django-insecure-ldu3pnrnvwn=*9&&7&u-8^(jf98kawghwjzmqnx#zkg@*=u2l8'
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "userauths.User": "fas fa-th",
        "hotel.Booking": "fas fa-calendar-alt",
